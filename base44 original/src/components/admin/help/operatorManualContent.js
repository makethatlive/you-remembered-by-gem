// Single source of the operator manual rendered by the admin Help tab.
// docs/OPERATOR-MANUAL.md in this repo must stay byte-identical to the text
// below (same body; the .md file adds only its HTML comment header).
// RULES for editing this string: no backtick characters, no dollar-brace
// sequences, no markdown pipe tables (react-markdown here has no gfm plugin).
export const OPERATOR_MANUAL_MD = `
