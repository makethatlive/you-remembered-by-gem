...
export const CANONICAL_INTERESTS = [
  { key: "Cooking & food", ui: true,
    keywords: ["cook", "cooking", "chef", "kitchen", "food", "recipe", "bake", "gourmet", "dining", "hamper", "coffee", "tea", "maker", "pan", "pot", "utensil"],
    aliases: ["food", "cooking", "food and drink"] },
  { key: "Wine & drinks", ui: true,
    keywords: ["wine", "champagne", "prosecco", "sommelier", "beer", "brew", "cider", "drink"],
  ...
  { key: "Gardening", ui: true,
    keywords: ["garden", "plant", "botanical", "flower", "grow", "seed", "pot", "planter", "fork", "spade", "trowel", "outdoor"],
    aliases: ["garden"] },
  { key: "Tech & gadgets", ui: true,
    keywords: ["tech", "gadget", "smart", "wireless", "electronic", "charger", "speaker", "headphone", "bluetooth", "usb", "digital", "device"],
  ...
  { key: "DIY & tools", ui: true,
    keywords: ["diy", "tool", "drill", "hammer", "screwdriver", "wrench", "toolbox", "toolkit", "handyman", "build", "fix", "repair"],
    aliases: ["diy", "tools", "diy and tools"] },
